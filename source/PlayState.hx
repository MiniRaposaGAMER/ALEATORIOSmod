...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['teucu!', 0.2], //From 0% to 19%
		['Seilaporrakkkkkkk', 0.4], //From 20% to 39%
		['nsei', 0.5], //From 40% to 49%
		['j', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['legal e o meuj ovo', 0.8], //From 70% to 79%
		['foda', 0.9], //From 80% to 89%
		['incrivel seara!', 1], //From 90% to 99%
		['ed!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
